        ...
        <div className="w-full max-w-md bg-white shadow-2xl rounded-2xl sm:rounded-[2rem] overflow-hidden border border-red-50">
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-2.5 sm:space-y-5">
            ...
            <div className="space-y-0.5 sm:space-y-1">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="block w-full pl-9 sm:pl-11 pr-10 sm:pr-12 py-2 sm:py-3 bg-gray-50 border-transparent rounded-xl sm:rounded-2xl text-xs sm:text-base focus:bg-white focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all outline-none"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full flex items-center justify-center gap-2 py-2.5 sm:py-4 rounded-xl sm:rounded-2xl text-white font-bold shadow-lg shadow-red-200 transition-all active:scale-95 mt-2 sm:mt-4 text-xs sm:text-base ${loading ? "bg-gray-400" : "bg-red-600 hover:bg-red-700"
                }`}
            >
