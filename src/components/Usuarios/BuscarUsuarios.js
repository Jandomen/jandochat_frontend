      ...
      <div className="p-4 space-y-3 bg-white sticky top-0 z-20">
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-1.5 bg-gray-50 hover:bg-red-50 rounded-xl text-gray-400 hover:text-red-500 transition-all border border-transparent hover:border-red-100"
          >
        ...
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            <Search className="h-4 w-4 text-gray-300 group-focus-within:text-red-500 transition-colors" />
          </div>
          <input
            type="text"
            placeholder="Buscar..."
              ...
              <>
                ...
                {resultados.map((usuario) => (
                  <div
                    ...
                    className="group flex items-center gap-3 p-3 rounded-2xl hover:bg-red-50 cursor-pointer transition-all border border-transparent hover:border-red-100 bg-gray-50/20"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-black text-gray-900 truncate group-hover:text-red-700 transition-colors text-xs">{usuario.nombre}</p>
                      <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">@{usuario.username || 'usuario'}</p>
                    </div>
                    <div className="p-2 bg-white text-gray-200 group-hover:bg-red-600 group-hover:text-white rounded-xl shadow-sm transition-all">
